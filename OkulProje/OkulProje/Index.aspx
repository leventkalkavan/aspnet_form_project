<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="OkulProje.Index" %>
...
<body>
                ...
                <div class="nav_w3ls ml-lg-5">
                    <nav>
                        ...
                        <ul class="menu">
                            ...
                            <li><a href="KayitOl.aspx">Kayıt</a></li>
                        </ul>
                    </nav>
                </div>
                <!-- //nav -->
    ...
    <div class="main-w3pvt mian-content-wthree text-center" id="home">
        <div class="container">
            <div class="style-banner mx-auto">
                <h3 class="text-wh font-weight-bold"><span>Fener Okulları</span> <br>Eğitimde Marka</h3>
                <p class="mt-3 text-li" id="join">Aramıza katılın.</p>
                <!-- form -->
                    ...
                    <form action="#" method="post">
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    <input class="form-control" type="text" name="Name" placeholder="Soyad"
                                        required="">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <input class="form-control" type="text" name="Name" placeholder="Telefon Numarası"
                                        required="">
                                </div>
                                <div class="form-group">
                                    <textarea class="form-control" name="Name" placeholder="Mesajın" required=""></textarea>
                                </div>
                            </div>
                        </div>
                        <button type="submit" class="btn_apt btn">Kayıt</button>
                    </form>
                </div>
                <!-- //form -->
            </div>
    ...
    <section class="w3ls-bnrbtm py-5" id="about">
        <div class="container py-xl-5 py-lg-3">
            <h3 class="title-w3 mb-md-5 mb-sm-4 mb-2 text-center font-weight-bold">Hakkında</h3>
            <div class="row">
            ...
            <div class="row footer-grids">
                ...
                <div class="col-lg-2 col-6 footer-grid text-lg-right">
                    <ul class="list-unstyled">
                        ...
                        <li>
                            <a href="KayitOl.aspx">Register</a>
                        </li>
                        <li>
